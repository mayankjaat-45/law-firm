...
function DetailPanel({ selectedDetail, onClose, onContact }) {
  ...
  return (
    <motion.div
      className="fixed inset-0 z-[998] flex items-center justify-center bg-black/80 px-4 backdrop-blur-md"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
    >
      ...
      >
        <button
          onClick={onClose}
          className="absolute right-5 top-5 z-10 flex h-10 w-10 items-center justify-center rounded-full bg-[#08111f] text-white transition hover:bg-[#d4af37] hover:text-[#08111f] dark:bg-white/10"
          aria-label="Close"
        >
          <X size={18} />
        </button>
        ...
        <div className="relative">
          <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-[#08111f] text-[#d4af37] dark:bg-white/10">
            <Icon size={32} />
          </div>

          <p className="mb-3 text-sm font-bold uppercase tracking-[0.25em] text-[#a47c15] dark:text-[#d4af37]">
            {selectedDetail.type === "insight"
              ? selectedDetail.category
              : "Practice Detail"}
          </p>

          <h2 className="law-serif max-w-3xl text-4xl font-semibold leading-tight text-[#08111f] dark:text-white sm:text-5xl">
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row">
            <button
              onClick={onContact}
              className="inline-flex items-center justify-center gap-2 rounded-full bg-[#d4af37] px-7 py-4 text-sm font-semibold text-[#08111f] transition hover:bg-[#08111f] hover:text-white dark:hover:bg-white dark:hover:text-[#08111f]"
            >
              Discuss This Matter
              <ArrowRight size={17} />
            </button>
            ...
            <button
              onClick={onClose}
              className="inline-flex items-center justify-center rounded-full border border-black/10 bg-white px-7 py-4 text-sm font-semibold text-[#08111f] transition hover:border-[#d4af37] hover:text-[#a47c15] dark:border-white/10 dark:bg-white/10 dark:text-white"
            >
              Back to Website
            </button>
          </div>
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#f8f3e8] text-[#121826] transition-colors duration-300 dark:bg-[#05070d] dark:text-white">
      <AnimatePresence>
        {showDisclaimer && (
          <motion.div
            className="fixed inset-0 z-[999] flex items-center justify-center bg-black/80 px-5 backdrop-blur-md"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          >
            ...
            >
              ...
              <div className="relative">
                <motion.div
                  ...
                  className="mb-5 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-[#08111f] text-[#d4af37] dark:bg-white/10"
                >
                  <Scale size={28} />
                </motion.div>
                ...
                <button
                  ...
                  className="w-full rounded-full bg-[#d4af37] px-6 py-4 text-sm font-semibold text-[#08111f] transition hover:bg-[#08111f] hover:text-white dark:hover:bg-white dark:hover:text-[#08111f]"
                >
                  I Agree & Continue
                </button>
              </div>
      ...
      <header className="fixed left-0 top-0 z-50 w-full border-b border-white/10 bg-[#08111f]/90 text-white backdrop-blur-2xl transition-colors">
        <div className="hidden border-b border-white/10 px-5 py-2 text-xs font-medium text-white/60 lg:block">
          <div className="mx-auto flex max-w-7xl items-center justify-between">
            <span>Professional legal consultation and advisory services</span>
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 lg:px-8">
          <a href="#home" className="flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#d4af37] text-[#08111f] shadow-lg">
              <Scale size={25} />
            </div>

            <div>
              <h1 className="law-serif text-xl font-bold leading-none tracking-tight">
                {firm.name}
              </h1>
        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.div
              ...
              className="overflow-hidden border-t border-white/10 bg-[#08111f] px-5 lg:hidden"
            >
              <motion.div
      ...
      <section
        id="home"
        className="law-hero-bg law-pattern relative overflow-hidden px-5 pb-20 pt-32 sm:pt-36 lg:px-8 lg:pb-28 lg:pt-44"
      >
        <motion.div
          animate={{ scale: [1, 1.08, 1], opacity: [0.5, 0.9, 0.5] }}
          transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }}
          className="absolute left-[-140px] top-24 h-96 w-96 rounded-full bg-[#d4af37]/20 blur-3xl"
        />

        <motion.div
          animate={{ scale: [1, 1.05, 1], opacity: [0.4, 0.8, 0.4] }}
          transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
          className="absolute right-[-140px] top-40 h-[28rem] w-[28rem] rounded-full bg-white/10 blur-3xl"
        />
        ...
        >
          <motion.div variants={fadeUp}>
            <motion.div
              variants={fadeUp}
              className="mb-6 inline-flex items-center gap-2 rounded-full border border-[#d4af37]/40 bg-white/70 px-4 py-2 text-sm font-semibold text-[#a47c15] shadow-sm backdrop-blur dark:bg-white/10 dark:text-[#f4d46b]"
            >
              <Sparkles size={16} />
            ...
            <motion.h2
              variants={fadeUp}
              className="law-serif max-w-4xl text-5xl font-semibold leading-[1.05] tracking-[-0.05em] text-[#08111f] dark:text-white sm:text-6xl lg:text-7xl"
            >
            ...
            <motion.p
              variants={fadeUp}
              className="mt-6 max-w-2xl text-base leading-8 text-gray-700 dark:text-white/70 sm:text-lg"
            >
            ...
            >
              <a
                href="#contact"
                className="group inline-flex items-center justify-center gap-2 rounded-full bg-[#d4af37] px-7 py-4 text-sm font-semibold text-[#08111f] shadow-xl shadow-black/20 transition hover:bg-white"
              >
              ...
              <a
                href="#practice"
                className="inline-flex items-center justify-center gap-2 rounded-full border border-black/10 bg-white/80 px-7 py-4 text-sm font-semibold text-[#08111f] shadow-sm transition hover:border-[#d4af37] hover:text-[#a47c15] dark:border-white/15 dark:bg-white/10 dark:text-white dark:hover:border-[#d4af37] dark:hover:text-[#d4af37]"
              >
            ...
            >
              {stats.map(([value, label]) => (
                <motion.div
                  ...
                  key={label}
                  className="rounded-3xl border border-black/10 bg-white/75 p-4 shadow-sm backdrop-blur dark:border-white/10 dark:bg-white/10"
                >
                  <p className="law-serif text-3xl font-bold text-[#d4af37]">
                    {value}
                  </p>
                  <p className="mt-1 text-xs font-medium text-gray-600 dark:text-white/60">
                    {label}
                  </p>
                </motion.div>
              ))}
          ...
          <motion.div variants={fadeLeft} className="relative">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/55">Ethical legal support</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/55">Secure consultation</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-white/10 p-4 shadow-2xl backdrop-blur sm:p-6"
            >
              <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#1f2937] via-[#111827] to-black p-7 text-white">
                ...
                <div className="relative">
                  ...
                  <h3 className="law-serif mt-4 text-4xl font-semibold tracking-tight">
                  ...
                  <div className="mt-8 space-y-4">
                    {[
                      ...
                      <div key={item} className="flex items-center gap-3">
                        <CheckCircle2 className="text-[#d4af37]" size={19} />
      ...
      <section className="border-y border-black/10 bg-white/75 px-5 py-5 backdrop-blur dark:border-white/10 dark:bg-white/[0.04] lg:px-8">
        <motion.div
          variants={staggerContainer}
          initial="hidden"
          whileInView="show"
      ...
      <section id="about" className="relative px-5 py-24 lg:px-8">
        ...
        >
          <motion.div variants={fadeUp}>
            ...
            <h2 className="law-serif text-4xl font-semibold leading-tight text-[#08111f] dark:text-white sm:text-5xl">
      ...
      <section
        id="practice"
        className="relative overflow-hidden bg-[#eee5d4] px-5 py-24 dark:bg-white/[0.03] lg:px-8"
      >
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          >
            {practiceAreas.map((item, index) => (
              ...
              >
                <div className="absolute right-5 top-5 law-serif text-6xl font-bold text-black/[0.04] dark:text-white/[0.04]">
                  0{index + 1}
                </div>

                <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#08111f] text-[#d4af37] transition group-hover:bg-[#d4af37] group-hover:text-[#08111f] dark:bg-white/10">
                  <item.icon size={27} />
                </div>
      ...
      <section className="px-5 py-20 lg:px-8">
        <motion.div
          ...
          whileInView="show"
          viewport={{ once: true, amount: 0.2 }}
          className="mx-auto grid max-w-7xl overflow-hidden rounded-[2.5rem] bg-[#08111f] shadow-2xl lg:grid-cols-[1.1fr_0.9fr]"
        >
          <div className="relative p-8 text-white sm:p-12 lg:p-14">
            <div className="absolute left-0 top-0 h-72 w-72 rounded-full bg-[#d4af37]/20 blur-3xl" />
            ...
            <div className="relative">
              ...
              <h2 className="law-serif max-w-3xl text-4xl font-semibold leading-tight sm:text-5xl">
              ...
              <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                <a
                  href="#contact"
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-[#d4af37] px-7 py-4 text-sm font-semibold text-[#08111f] transition hover:bg-white"
                >
                  Request Consultation
                  <ArrowRight size={17} />
                </a>
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-full border border-white/15 bg-white/10 px-7 py-4 text-sm font-semibold text-white transition hover:border-[#d4af37] hover:text-[#d4af37]"
                >
                  <Phone size={17} />
                  Call Now
                </a>
          ...
          <div className="relative min-h-[320px] bg-[#d4af37] p-8 text-[#08111f] sm:p-12">
            <div className="absolute bottom-0 right-0 law-serif text-[12rem] font-black leading-none text-black/10">
              §
            </div>
            ...
            <div className="relative flex h-full flex-col justify-between">
              <div>
                ...
                <h3 className="law-serif mt-4 text-4xl font-semibold">
      ...
      <section id="process" className="px-5 py-20 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          >
            ...
            <h2 className="law-serif mx-auto max-w-3xl text-4xl font-semibold leading-tight text-[#08111f] dark:text-white sm:text-5xl">
            ...
            {processSteps.map((step, index) => (
              ...
              >
                <div className="mb-6 flex items-center justify-between">
                  <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#08111f] text-[#d4af37] dark:bg-white/10">
                    <step.icon size={25} />
                  </div>
      ...
      <section className="px-5 pb-20 lg:px-8">
        ...
        >
          <motion.div
            variants={fadeUp}
            className="relative overflow-hidden rounded-[2.5rem] bg-[#08111f] p-8 text-white shadow-2xl sm:p-10"
          >
            <div className="absolute right-0 top-0 h-72 w-72 rounded-full bg-[#d4af37]/20 blur-3xl" />
            ...
            <div className="relative">
              ...
              <h2 className="law-serif text-4xl font-semibold leading-tight sm:text-5xl">
          ...
          >
            ...
            <div className="flex flex-col gap-6 sm:flex-row sm:items-center">
              <motion.div
                ...
                className="flex h-28 w-28 shrink-0 items-center justify-center rounded-[2rem] bg-[#08111f] text-[#d4af37] dark:bg-white/10"
              >
                <Gavel size={48} />
              </motion.div>

              <div>
                <h3 className="law-serif text-4xl font-semibold text-[#08111f] dark:text-white">
                  Adv. Aarav Mehra
                </h3>
      ...
      <section
        id="insights"
        className="bg-[#eee5d4] px-5 py-24 dark:bg-white/[0.03] lg:px-8"
      >
        <div className="mx-auto max-w-7xl">
          <motion.div
            variants={fadeUp}
          ...
          >
            ...
            <div className="mt-10 space-y-4">
              {[
                ...
                >
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#08111f] text-[#d4af37] dark:bg-white/10">
                    <item.icon size={22} />
                  </div>
          ...
          >
            ...
            <div className="relative">
              <div className="mb-6 rounded-3xl bg-[#08111f] p-5 text-white">
                ...
                <h3 className="law-serif mt-2 text-3xl font-semibold">
              ...
              <button
                type="button"
                className="mt-6 flex w-full items-center justify-center gap-2 rounded-full bg-[#d4af37] px-7 py-4 text-sm font-semibold text-[#08111f] transition hover:bg-[#08111f] hover:text-white dark:hover:bg-white dark:hover:text-[#08111f]"
              >
                Submit Enquiry
                <ArrowRight size={17} />
              </button>
              ...
              <p className="mt-5 text-center text-xs leading-6 text-gray-500 dark:text-gray-400">
                ...
                relationship. The firm will contact you for further discussion.
              </p>
            </div>
          </motion.form>
        </div>
      ...
      <footer className="border-t border-white/10 bg-[#08111f] px-5 pt-16 text-white lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 pb-12 md:grid-cols-2 lg:grid-cols-4">
          <div>
            <div className="mb-5 flex items-center gap-3">
              ...
              <div>
                <p className="law-serif text-xl font-bold">{firm.name}</p>
      ...
      <div className="fixed bottom-5 right-5 z-40 flex flex-col gap-3">
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          href={`tel:${firm.phone.replace(/\s/g, "")}`}
          className="flex h-12 w-12 items-center justify-center rounded-full bg-[#08111f] text-[#d4af37] shadow-xl transition hover:bg-[#d4af37] hover:text-[#08111f] dark:bg-[#d4af37] dark:text-[#08111f] dark:hover:bg-white"
          aria-label="Call"
        >
          <Phone size={20} />
        </motion.a>
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          href="#contact"
          className="flex h-12 w-12 items-center justify-center rounded-full bg-[#d4af37] text-[#08111f] shadow-xl transition hover:bg-[#08111f] hover:text-[#d4af37] dark:hover:bg-white"
          aria-label="Message"
        >
